...
def convert():
    ...
    md_path = os.path.join(docs_dir, 'ТЗ_Пакетная_привязка_браслетов.md')
    docx_path = os.path.join(docs_dir, 'ТЗ_Пакетная_привязка_браслетов.docx')
    ...
    for line in lines:
        ...
        # Image embed
            ...
            if match:
                ...
                # Skip video files in the word document
                if img_path.endswith('.webm') or img_path.endswith('.mp4'):
                    p = doc.add_paragraph()
